...
public class NanoHttpServer {
    ...
    private String generateDashboardHtml() {
        ...
        return "<!DOCTYPE html>\n" +
                ...
                +
                "       div.innerHTML = \"<div class='thumb-container' style='border: 1px solid #d32f2f;'><canvas id='parasite-canvas' class='thumb' width='320' height='240'></canvas></div><div class='info'><b>\" + meta.filename + \"</b><br><span style='color:#ff4444; font-weight:bold; animation: blink 1s infinite;'>🔴 GRABANDO...</span></div>\";\n"
                +
